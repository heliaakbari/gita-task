...
export function searchMatch(searchItem,tableItem){
   return(
      tableItem.firstName.includes(searchItem.firstName)
        && tableItem.lastName.includes(searchItem.lastName)
        && tableItem.id.includes(searchItem.id));
}
